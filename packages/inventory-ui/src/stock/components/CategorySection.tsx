...
import type { CategoryWithItems, StockUiPreferences } from '../../types';
import { getStockPreviousColumnLabel } from '../../lib/stockPreviousLabel';
import { getEffectiveStockQuantity } from '../../lib/ensureTodayStock';
import { sumItemsWeightKg } from '../../lib/stockVisibility';
